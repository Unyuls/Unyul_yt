...
// Memoized social link card
const SocialCard = memo(function SocialCard({ link }: { link: SocialLink }) {
  return (
    <motion.a
      href={link.href}
      target="_blank"
...
// Static icon components defined once
const YoutubeIcon = (
  <svg
    viewBox="0 0 256 256"
    fill="currentColor"
...
const Find = memo(function Find() {
  // Memoize social links to prevent recreation on each render
